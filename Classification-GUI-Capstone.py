...
model = load_model("C:\\Users\\61423\\Desktop\\ST1\\Capstone\\Stage3\\TrainedModel\\keras_model.h5")

# Load the labels
label_path = 'C:\\Users\\61423\\Desktop\\ST1\\Capstone\\Stage3\\TrainedModel\\labels.txt'
class_names = open(label_path, "r").readlines()

test_image_path = 'C:\\Users\\61423\\Desktop\\ST1\\Capstone\\Stage3\\Adenocarcinoma\\000013 (4).png'
data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)

# Initialize GUI
top = tk.Tk()
top.geometry('800x600')
top.title('CT Scan image classification')
...
heading = Label(top, text="CT Scan Image Classifier", pady=20, font=('arial', 20, 'bold'))
